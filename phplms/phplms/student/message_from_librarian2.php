                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="search_books.php"><i class="fa fa-edit"></i> View Books <span class="fa fa-chevron-down"></span></a>
                ...
                <nav>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li role="presentation" class="dropdown">
                            <a href="message_from_librarian2.php" class="dropdown-toggle info-number" data-toggle="dropdown"
                               aria-expanded="false">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                          ...
                          <table class="table table-bordered">
                            ...
                            <th>message</th>
                            <?php
                              $sql3= "select * from messages where dusername = '$_SESSION[userID]' order by id desc";
                            $result =  mysqli_query($conn, $sql3);
                            while($row = mysqli_fetch_assoc($result)){
                              $sql4 = "select * from librarian_registration where username ='$row[susername]'";
