                ...
                <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                    <div class="menu_section">
                        ...
                        <ul class="nav side-menu">
                            ...
                            <li><a href="display_books.php"><i class="fa fa-bar-chart-o"></i>View Books <span
                                    class="fa fa-chevron-down"></span></a>
                                ...
                                <form class="" action="" method="post" class="col-lg-6">
                                  <table class ="table">
                                    <tr>
                                      <td>
                                  <?php
                                    echo "<select class = 'form-control' name ='dusername'>";
                                                                  $sql = "select * from student_registration ";
                                                                  $result = mysqli_query($conn, $sql);
                                                                  while($row=mysqli_fetch_assoc($result)){

                                                                    echo "<option value = '$row[username]'>";
                                                                    echo $row['username']."(".$row['roll_no'].")";
                                                                    echo "</option>";
                                        ...
                                        <tr>
                                          <td><input type="submit" name = "submit1" class ="form-control"value="Send Message" name=""></td>
                                        </tr>
                                  </table>
                                </form>
                                <?php
                                if(isset($_POST['submit1'])){
                                  $sql = "insert into messages(susername,dusername,title,message,readss) values('$_SESSION[librarian]','$_POST[dusername]','$_POST[title]','$_POST[msg]','n')";
