                                                ...
                                                <?php
                                                    ...
                                                    while($row = mysqli_fetch_assoc($result)){
                                                      ...
                                                      echo "<th>";   echo $row['books_author_name'];  echo  "</th>";
                                                        ...
                                                        echo "<th>";   echo $row['books_qty'];  echo  "</th>";

                                                      echo "<th>";   echo $row['available_qty'];  echo  "</th>";
                                                          echo "<th>";
                                                          ?>
                                                          <a href='all_student_of_this_book.php?books_name=<?php echo $row["books_name"]; ?>'>search</a>   </th>
                                                      <?php
                                                      echo "</tr>";
                                                    }
