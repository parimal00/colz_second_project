...
//echo $_GET['ssid'];
                              ...
                              $sql = "select * from issue_books where ssid= '$_GET[ssid]' and books_return_date = 'waiting'";
                              $result = mysqli_query($conn,$sql);


                             $a = date("y-m-d");

                             $sql5 = "select books_issue_date from issue_books where ssid = '$_GET[ssid]'";
