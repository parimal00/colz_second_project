...
<div class="container body">
                    ...
                    <div class="col-md-12 col-sm-12 col-xs-12">
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                              ...
                              $result =  mysqli_query($conn,"select * from student_account where roll_no ='$roll_number'");
                              ...
                              $bal_due = $row['balance_due'];

                            echo '<tr>';
                            echo '<th>'; echo $roll; echo '</th>';
                              echo '<th>'; echo $name; echo '</th>';
                                echo '<th>'; echo $contact; echo '</th>';
                                  echo '<th>'; echo $sem_fee; echo '</th>';
                                    echo '<th>'; echo $bal_due; echo '</th>';
                            echo '</tr>';
  ...
  $result =  mysqli_query($conn,"select * from student_account");
